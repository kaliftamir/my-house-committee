...
function CommitteeNavbar (props) {
    ...
    const { activeUser } = props    
        ...
        // rendering the menu items depending on whether we have an active user or not
         ...
         const dashboardMenuItem = activeUser ? <Nav.Link href="#">Dashboard</Nav.Link> : null;
         const tenantsMenuItem = activeUser ? <Nav.Link href="#">Tenants</Nav.Link> : null;
         const messagesMenuItem = activeUser ? <Nav.Link href="#">Messages</Nav.Link> : null;
         const votingMenuItem = activeUser ? <Nav.Link href="#">Voting</Nav.Link> : null;
